Pod::Spec.new do |s|
	...
	s.ios.resources = ['imglyKit/Frontend/Assets.xcassets', 'imglyKit/Frontend/en.lproj/Localizable.strings','imglyKit/Frontend/ImagePicker/Assets.xcassets', 'imglyKit/Backend/Filter Responses/*.png', 'imglyKit/Backend/Fonts/*']
